...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # 版本管理器段（asdf/pyenv/goenv/nodenv/nvm/nodeenv）对 mise 无效，已禁用，
    # 改用下面的直接 *_version 段：直接读 PATH 里的二进制，能显示 mise 提供的版本
    virtualenv              # python virtual environment (https://docs.python.org/3/library/venv.html)
    anaconda                # conda environment (https://conda.io/)
    node_version            # node.js 版本（mise 提供，仅项目目录显示）
    go_version              # go 版本（mise 提供，仅项目目录显示）
    rust_version            # rustc 版本（仅项目目录显示）
    php_version             # php 版本（仅项目目录显示）
    java_version            # java 版本（仅项目目录显示）
    dotnet_version          # .NET 版本（mise 提供，仅项目目录显示）
    ...
    # phpenv                # php version from phpenv —— mise 用户改用上面的 php_version
